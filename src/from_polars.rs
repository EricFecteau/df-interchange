                ...
                pub fn [<from_polars_ $from_ver>](df: [<polars_crate_ $from_ver>]::frame::DataFrame) -> Self {
                    Self {
                        ffi: {
                            ...
                            let src_series: Vec<[<polars_crate_ $from_ver>]::series::Series> = df
                                .take_columns()
                                .into_iter()
...
#[cfg(any(feature = "polars_0_42", feature = "polars_0_43"))]
macro_rules! polars_to_ffi {
    ($from_ver:literal) => {
        paste! {
            impl Interchange {
                ...
                pub fn [<from_polars_ $from_ver>](df: [<polars_crate_ $from_ver>]::frame::DataFrame) -> Self {
                    Self {
                        ffi: {
                            ...
                            let src_series: Vec<[<polars_crate_ $from_ver>]::series::Series> = df.take_columns();
